 ...
 */
DPM_API int dpm_wifi_set_profile_change_restriction(device_policy_manager_h handle, bool enable);
 ...
 * @since_tizen 3.0
 * @param[in]   handle The device policy manager handle
 * @param[out]  is_restricted true if one or more administrators enabled restriction
 ...
 */
DPM_API int dpm_wifi_is_profile_change_restricted(device_policy_manager_h handle, bool *enable);
 ...
 */
DPM_API int dpm_wifi_set_network_access_restriction(device_policy_manager_h handle, bool enable);
 ...
 * @since_tizen 3.0
 * @param[in]   handle The device policy manager handle
 * @param[out]  enable true if restriction mode is enabled or
 ...
 */
DPM_API int dpm_wifi_is_network_access_restricted(device_policy_manager_h handle, bool *enable);
