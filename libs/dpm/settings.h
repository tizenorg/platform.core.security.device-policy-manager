...
/**
 * @file settings.h
 * @brief This file provides APIs to control settings functionality
 */
...
/**
 * @brief       The settings policy handle
 * @since_tizen 3.0
...
/**
 * @brief       Acquires the settings policy handle.
 * @details     This API acquires device settings policy handle required to enforce
 *              the settings policies.
 * @since_tizen 3.0
 * @param[in]   handle The settings policy handle
 * @return      Settings policy handle on success, otherwise NULL
