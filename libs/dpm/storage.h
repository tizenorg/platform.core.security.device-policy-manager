 ...
 *              the privilege to enforce storage policies.
 * @see         dpm_context_release_storage_policy()
 * @see         get_last_result()
 */
 ...
 */
DPM_API int dpm_storage_set_external_storage_state(dpm_storage_policy_h handle, int enable);
 ...
 */
DPM_API int dpm_storage_get_external_storage_state(dpm_storage_policy_h handle);
