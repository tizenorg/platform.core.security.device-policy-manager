 ...
 * @see         dpm_manager_create()
 */
DPM_API int dpm_password_set_minimum_length(device_policy_manager_h handle, int value);
 ...
 * @see         dpm_manager_create()
 */
DPM_API int dpm_password_set_min_complex_chars(device_policy_manager_h handle, int value);
 ...
 * @see         dpm_manager_create()
 */
DPM_API int dpm_password_set_maximum_failed_attempts_for_wipe(device_policy_manager_h handle, int value);
 ...
 * @see         dpm_manager_create()
 */
DPM_API int dpm_password_set_expires(device_policy_manager_h handle, int value);
 ...
 * @see         dpm_manager_create()
 */
DPM_API int dpm_password_set_history(device_policy_manager_h handle, int value);
 ...
 * @see         dpm_manager_create()
 */
DPM_API int dpm_password_set_max_inactivity_time_device_lock(device_policy_manager_h handle, int value);
 ...
 * @see         dpm_manager_create()
 */
DPM_API int dpm_password_set_maximum_character_occurrences(device_policy_manager_h handle, int value);
 ...
 * @see         dpm_manager_create()
 */
DPM_API int dpm_password_set_maximum_numeric_sequence_length(device_policy_manager_h handle, int value);
