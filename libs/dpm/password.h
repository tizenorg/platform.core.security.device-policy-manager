...
/**
 * @addtogroup  CAPI_SECURITY_DPM_PASSWORD_POLICY_MODULE
 * @{
 */

/**
 * @brief       The Device Policy Password handle
 * @details     The Device Policy Password Handle is an abstraction of the
 *              logical connection between the device policy manager and
 *              it's client. The Device Policy Password handle must be
 ...
 * @param[in]   handle Device Policy Password handle
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_set_quality(dpm_password_h handle, const char *username, dpm_password_quality_e quality);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_set_minimum_length(dpm_password_h handle, const char *username, const int value);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_set_min_complex_chars(dpm_password_h handle, const char *username, const int value);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_set_maximum_failed_attempts_for_wipe(dpm_password_h handle, const char *username, const int value);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_set_expires(dpm_password_h handle, const char *username, const int value);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_set_history(dpm_password_h handle, const char *username, const int value);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_set_pattern(dpm_password_h handle, const char *username, const char *pattern);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_reset(dpm_password_h handle, const char *username, const char *password);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_enforce_change(dpm_password_h handle, const char *username);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_set_max_inactivity_time_device_lock(dpm_password_h handle, const char *username, const int value);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_get_max_inactivity_time_device_lock(dpm_password_h handle, const char *username, int *value);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_set_status(dpm_password_h handle, const char *username, const int status);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_delete_pattern(dpm_password_h handle, const char *username);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API char *dpm_password_get_pattern(dpm_password_h handle, const char *username);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_set_maximum_character_occurrences(dpm_password_h handle, const char *username, const int value);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_get_maximum_character_occurrences(dpm_password_h handle, const char *username, int *value);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_set_maximum_numeric_sequence_length(dpm_password_h handle, const char *username, const int value);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_get_maximum_numeric_sequence_length(dpm_password_h handle, const char *username, int *value);
