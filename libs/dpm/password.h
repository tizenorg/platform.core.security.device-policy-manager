...
/**
 * @brief       The PasswordPolicy Policy handle
 * @since_tizen 3.0
...
/**
 * @brief       Acquires the PasswordPolicy Policy handle.
...
/**
 * @brief       Releases the PasswordPolicy Policy Handle.
 ...
 * @param[in]   handle PasswordPolicy Policy handle
 * @param[in]   quality PasswordPolicy Quality Type
 * @return      #DPM_ERROR_NONE on success, otherwise a negative value
 * @retval      #DPM_ERROR_NONE Successful
 * @retval      #DPM_ERROR_INVALID_PARAMETER Invalid parameter
 * @retval      #DPM_ERROR_TIMED_OUT Time out
 ...
 * @privilege   %http://tizen.org/privilege/dpm.password
 * @param[in]   handle PasswordPolicy Policy handle
 * @param[in]   pattern PasswordPolicy Pattern. If regular expression is
 ...
 * @privilege   %http://tizen.org/privilege/dpm.password
 * @param[in]   handle PasswordPolicy Policy handle
 * @param[in]   password New PasswordPolicy
 * @return      #DPM_ERROR_NONE on success, otherwise a negative value
 * @retval      #DPM_ERROR_NONE Successful
 * @retval      #DPM_ERROR_INVALID_PARAMETER Invalid parameter
 * @retval      #DPM_ERROR_TIMED_OUT Time out
 ...
 * @privilege   %http://tizen.org/privilege/dpm.password
 * @param[in]   handle PasswordPolicy Policy handle
 * @param[in]   status PasswordPolicy Status
 * @return      #DPM_ERROR_NONE on success, otherwise a negative value
 * @retval      #DPM_ERROR_NONE Successful
 * @retval      #DPM_ERROR_INVALID_PARAMETER Invalid parameter
 * @retval      #DPM_ERROR_TIMED_OUT Time out
 ...
 * @param[in]   handle PasswordPolicy Policy handle
 * @param[out]   pattern PasswordPolicy pattern
 * @return      #DPM_ERROR_NONE on success, otherwise a negative value
 * @retval      #DPM_ERROR_NONE Successful
 * @retval      #DPM_ERROR_INVALID_PARAMETER Invalid parameter
 * @retval      #DPM_ERROR_TIMED_OUT Time out
