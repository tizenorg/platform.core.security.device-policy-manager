 ...
 * @details     The Password Policy Handle is an abstraction of the
 *              logical connection between the device policy manager and
 *              it's client. The Password Policy handle must be
 *              created by using dpm_context_create_password_policy() before attempting to
 *              use almost any of the device policy password APIs, and it should
 *              be freed when interaction with the Device Policy Manager
 *              is no longer required.
 *              To release the handle, use dpm_context_destroy_password_policy().
 * @since_tizen 3.0
 * @see         dpm_context_create_password_policy()
 * @see         dpm_context_destroy_password_policy()
 */
...
/**
 * @brief       Creates the Password Policy handle
 * @details     This API creates password policy handle required to
 ...
 * @see         get_last_result()
 */
DPM_API dpm_password_policy_h dpm_context_create_password_policy(dpm_context_h handle);
 ...
 * @return      None
 * @pre         The handle must be created by dpm_context_create_password_policy()
 * @see         dpm_context_create_password_policy()
 */
DPM_API void dpm_context_destroy_password_policy(dpm_password_policy_h handle);
 ...
 * @pre         handle must be created by dpm_context_create_password_policy()
 * @see         dpm_context_create_password_policy()
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_set_quality(dpm_password_policy_h handle, const char *username, dpm_password_quality_e quality);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_set_minimum_length(dpm_password_policy_h handle, const char *username, const int value);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_set_min_complex_chars(dpm_password_policy_h handle, const char *username, const int value);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_set_maximum_failed_attempts_for_wipe(dpm_password_policy_h handle, const char *username, const int value);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_set_expires(dpm_password_policy_h handle, const char *username, const int value);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_set_history(dpm_password_policy_h handle, const char *username, const int value);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_set_pattern(dpm_password_policy_h handle, const char *username, const char *pattern);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_reset(dpm_password_policy_h handle, const char *username, const char *password);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_enforce_change(dpm_password_policy_h handle, const char *username);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_set_max_inactivity_time_device_lock(dpm_password_policy_h handle, const char *username, const int value);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_get_max_inactivity_time_device_lock(dpm_password_policy_h handle, const char *username, int *value);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_set_status(dpm_password_policy_h handle, const char *username, const int status);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_delete_pattern(dpm_password_policy_h handle, const char *username);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API char *dpm_password_get_pattern(dpm_password_policy_h handle, const char *username);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_set_maximum_character_occurrences(dpm_password_policy_h handle, const char *username, const int value);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_get_maximum_character_occurrences(dpm_password_policy_h handle, const char *username, int *value);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_set_maximum_numeric_sequence_length(dpm_password_policy_h handle, const char *username, const int value);
 ...
 * @see         dpm_context_destroy_password_policy()
 */
DPM_API int dpm_password_get_maximum_numeric_sequence_length(dpm_password_policy_h handle, const char *username, int *value);
