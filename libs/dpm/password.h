 ...
 *              created by using dpm_context_acquire_password_policy() before attempting to
 ...
 *              To release the handle, use dpm_context_release_password_policy().
 * @since_tizen 3.0
 ...
 * @see         dpm_context_release_password_policy()
 */
DPM_API int dpm_password_get_pattern(dpm_password_policy_h handle, const char *username, char* pattern);
