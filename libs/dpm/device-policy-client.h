 ...
 * @details     This API can be used to receive signal. The callback specified to
 *              this function is automatically called when the device policy manager raises signal.
 * @since_tizen 3.0
 * @param[in]   context The zone policy handle
...
* @pre         The cb_handle must be created by dpm_context_add_signal_cb().
* @see         dpm_context_create()
* @see         dpm_context_destroy()
