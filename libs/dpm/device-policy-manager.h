 ...
 */
DPM_API int dpm_add_policy_changed_cb(device_policy_manager_h handle,
                                              const char* name,
 ...
 */
DPM_API int dpm_remove_policy_changed_cb(device_policy_manager_h handle,
                                                 int id);
/**
 ...
 */
DPM_API int dpm_add_signal_cb(device_policy_manager_h handle, const char* signal,
 ...
 */
DPM_API int dpm_remove_signal_cb(device_policy_manager_h handle, int id);
/**
 * @}
 */
