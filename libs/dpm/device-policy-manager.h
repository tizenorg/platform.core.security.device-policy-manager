 ...
 * @see         get_last_result()
 */
DPM_API device_policy_manager_h dpm_manager_create(void);
 ...
 * @see         dpm_manager_create()
 */
DPM_API int dpm_manager_destroy(device_policy_manager_h handle);
 ...
 * @see         dpm_manager_remove_policy_changed_cb()
 */
DPM_API int dpm_manager_add_policy_changed_cb(device_policy_manager_h handle,
                                              const char* name,
 ...
 * @see         dpm_manager_add_policy_changed_cb()
 */
DPM_API int dpm_manager_remove_policy_changed_cb(device_policy_manager_h handle,
                                                 int id);
/**
 ...
 * @see         dpm_manager_create()
 * @see         dpm_manager_destroy()
 * @see         dpm_manager_remove_signal_cb()
 */
DPM_API int dpm_manager_add_signal_cb(device_policy_manager_h handle, const char* signal,
 ...
 * @see         dpm_manager_create()
 * @see         dpm_manager_destroy()
 * @see         dpm_manager_add_signal_cb()
 */
DPM_API int dpm_manager_remove_signal_cb(device_policy_manager_h handle, int id);
/**
 * @}
 */
