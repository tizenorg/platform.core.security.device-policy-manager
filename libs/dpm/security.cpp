...
EXPORT_API int dpm_security_set_internal_storage_encryption(device_policy_manager_h handle, bool encrypt)
{
    RET_ON_FAILURE(handle, DPM_ERROR_INVALID_PARAMETER);
...
EXPORT_API int dpm_security_is_internal_storage_encrypted(device_policy_manager_h handle, bool *is_encrypted)
{
    RET_ON_FAILURE(handle, DPM_ERROR_INVALID_PARAMETER);
...
EXPORT_API int dpm_security_set_external_storage_encryption(device_policy_manager_h handle, bool encrypt)
{
    RET_ON_FAILURE(handle, DPM_ERROR_INVALID_PARAMETER);
...
EXPORT_API int dpm_security_is_external_storage_encrypted(device_policy_manager_h handle, bool *is_encrypted)
{
    RET_ON_FAILURE(handle, DPM_ERROR_INVALID_PARAMETER);
    RET_ON_FAILURE(is_encrypted, DPM_ERROR_INVALID_PARAMETER);
...
EXPORT_API int dpm_security_wipe_data(device_policy_manager_h handle, const dpm_security_wipe_type_e type)
{
    RET_ON_FAILURE(handle, DPM_ERROR_INVALID_PARAMETER);
