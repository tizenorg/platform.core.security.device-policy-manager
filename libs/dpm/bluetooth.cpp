...
int dpm_bluetooth_add_device_to_blacklist(device_policy_manager_h handle, const char* mac)
{
...
int dpm_bluetooth_remove_device_from_blacklist(device_policy_manager_h handle, const char* mac)
{
    RET_ON_FAILURE(handle, DPM_ERROR_INVALID_PARAMETER);
    RET_ON_FAILURE(mac, DPM_ERROR_INVALID_PARAMETER);
...
int dpm_bluetooth_set_device_restriction(device_policy_manager_h handle, bool enable)
{
    RET_ON_FAILURE(handle, DPM_ERROR_INVALID_PARAMETER);
...
int dpm_bluetooth_is_device_restricted(device_policy_manager_h handle, bool *state)
{
    RET_ON_FAILURE(handle, DPM_ERROR_INVALID_PARAMETER);
...
int dpm_bluetooth_set_uuid_restriction(device_policy_manager_h handle, bool enable)
{
    RET_ON_FAILURE(handle, DPM_ERROR_INVALID_PARAMETER);
...
int dpm_bluetooth_is_uuid_restricted(device_policy_manager_h handle, bool *state)
{
    RET_ON_FAILURE(handle, DPM_ERROR_INVALID_PARAMETER);
