...
dpm_bluetooth_policy_h dpm_context_acquire_bluetooth_policy(dpm_context_h handle)
{
    ...
    return client.createPolicyInterface<Bluetooth>();
}

int dpm_context_release_bluetooth_policy(dpm_bluetooth_policy_h handle)
{
    RET_ON_FAILURE(handle, DPM_ERROR_INVALID_PARAMETER);
    
    delete &GetPolicyInterface<Bluetooth>(handle);
    return 0;
}
...
int dpm_bluetooth_add_device_to_blacklist(dpm_bluetooth_policy_h handle, const char* mac_address)
{
    ...
    Bluetooth& bluetooth = GetPolicyInterface<Bluetooth>(handle);
...
int dpm_bluetooth_is_device_restricted(dpm_bluetooth_policy_h handle)
{
    RET_ON_FAILURE(handle, DPM_ERROR_INVALID_PARAMETER);
...
int dpm_bluetooth_is_uuid_restricted(dpm_bluetooth_policy_h handle)
{
    RET_ON_FAILURE(handle, DPM_ERROR_INVALID_PARAMETER);
