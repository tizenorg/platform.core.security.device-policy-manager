 ...
 * @details     This API acquires geofence policy handle required to call
 *              the device policy geofence APIs.
 * @since_tizen 3.0
 ...
 * @see         get_last_result()
 */
DPM_API dpm_geofence_policy_h dpm_context_acquire_geofence_policy(dpm_context_h handle, const char* zone);
 ...
 * @since_tizen 3.0
 * @param[in]   handle Geofence Policy Handle
