 ...
 * @since_tizen 3.0
 * @param[in]   handle The device policy manager handle
 * @param[in]   restruct If true, restrict the bluetooth pairing, if false, allow the bluetooth pairing
 * @return      #DPM_ERROR_NONE on success, otherwise a negative value
 * @retval      #DPM_ERROR_NONE Successful
 * @retval      #DPM_ERROR_TIMEOUT Time out
 * @retval      #DPM_ERROR_PERMISSION_DENIED The application does not have
 ...
 */
DPM_API int dpm_bluetooth_set_device_restriction(device_policy_manager_h handle, bool restrict);
 ...
 * @since_tizen 3.0
 * @param[in]   handle The device policy manager handle
 * @param[out]  is_restricted true if the bluetooth pairing has been restricted, else false
 * @return      #DPM_ERROR_NONE on success, otherwise a negative value
 * @retval      #DPM_ERROR_NONE Successful
 * @retval      #DPM_ERROR_TIMEOUT Time out
 * @pre         handle must be created by dpm_context_acquire_bluetooth_policy()
 ...
 */
DPM_API int dpm_bluetooth_is_device_restricted(device_policy_manager_h handle, bool *is_restricted);
 ...
 * @since_tizen 3.0
 * @param[in]   handle The device policy manager handle
 * @param[in]   restrict If true, restrict the bluetooth pairing, if false, allow the bluetooth pairing
 * @return      #DPM_ERROR_NONE on success, otherwise a negative value
 * @retval      #DPM_ERROR_NONE Successful
 * @retval      #DPM_ERROR_TIMEOUT Time out
 * @retval      #DPM_ERROR_PERMISSION_DENIED The application does not have
 ...
 */
DPM_API int dpm_bluetooth_set_uuid_restriction(device_policy_manager_h handle, bool restrict);
 ...
 */
DPM_API int dpm_bluetooth_is_uuid_restricted(device_policy_manager_h handle, bool *is_restricted);
