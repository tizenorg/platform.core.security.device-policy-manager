...
/**
 * @brief       API to add MAC address to blacklist
...
/**
 * @brief       API to remove MAC address from blacklist
...
/**
 * @brief       API to enable or disable device restriction of bluetooth
...
/**
 * @brief       API to get the allow device restriction status of the bluetooth
...
/**
 * @brief       API to add UUID to blacklist
...
/**
 * @brief       API to remove UUID from blacklist
...
/**
 * @brief       API to enable or disable UUID restriction of bluetooth
 * @details     An administrator can use this API to set whether the bluetooth
...
/**
 * @brief       API to get the allow UUID restriction status of the bluetooth
 * @details     An administrator can use this API to get the allow status of the
