 ...
 */
DPM_API int dpm_restriction_get_external_storage_state(device_policy_manager_h handle, int *state);
 ...
 */
DPM_API int dpm_restriction_get_clipboard_state(device_policy_manager_h handle, int *state);
 ...
 */
DPM_API int dpm_restriction_get_usb_debugging_state(device_policy_manager_h handle, int *state);
