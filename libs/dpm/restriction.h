 ...
 * @param[in]   allow If true, allow the clipboard, if false, disable the clipboard
 ...
 * @see         dpm_is_clipboard_allowed()
 */
DPM_API int dpm_allow_clipboard(dpm_client_h handle, int allow);
 ...
 * @see         dpm_create_client()
 * @see         dpm_destroy_client()
 * @see         dpm_allow_clipboard()
 */
DPM_API int dpm_is_clipboard_allowed(dpm_client_h handle);
 ...
 */
DPM_API int dpm_allow_settings_changes(dpm_client_h handle, int allow);
 ...
 */
DPM_API int dpm_is_settings_changes_allowed(dpm_client_h handle);
 ...
 */
DPM_API int dpm_allow_background_data(dpm_client_h handle, int allow);
 ...
 */
DPM_API int dpm_is_background_data_allowed(dpm_client_h handle);
 ...
 */
DPM_API int dpm_allow_usb_debugging(dpm_client_h handle, int allow);
 ...
 */
DPM_API int dpm_is_usb_debugging_allowed(dpm_client_h handle);
 ...
 */
DPM_API int dpm_allow_usb_mass_storage(dpm_client_h handle, int allow);
 ...
 */
DPM_API int dpm_is_usb_mass_storage_allowed(dpm_client_h handle);
 ...
 */
DPM_API int dpm_allow_factory_reset(dpm_client_h handle, int allow);
 ...
 */
DPM_API int dpm_is_factory_reset_allowed(dpm_client_h handle);

/**
 * @brief       API to allow or disable the bluetooth tethering
 ...
 * @privilege   %http://tizen.org/privilege/dpm.restriction
 * @param[in]   handle Device Policy Client handle
 * @param[in]   allow If true, allow the bluetooth tethering, if false, disable
 ...
 * @see         dpm_create_client()
 * @see         dpm_destroy_client()
 * @see         dpm_is_bluetooth_tethering_allowed()
 */
DPM_API int dpm_allow_bluetooth_tethering(dpm_client_h handle, int allow);
 ...
 * @see         dpm_create_client()
 * @see         dpm_destroy_client()
 * @see         dpm_allow_bluetooth_tethering()
 */
DPM_API int dpm_is_bluetooth_tethering_allowed(dpm_client_h handle);

/**
 * @brief       API to allow or disable the mock location
 * @details     An administrator can use this API to set whether the mock location
 *              is allowed or not
 * @since_tizen 3.0
 * @privlevel   public
 * @privilege   %http://tizen.org/privilege/dpm.restriction
 * @param[in]   handle Device Policy Client handle
 * @param[in]   allow If true, allow the mock location, if false, disable the mock
 *              location
 * @return      #DPM_ERROR_NONE on success, otherwise a negative value
 * @retval      #DPM_ERROR_NONE Successful
 * @retval      #DPM_ERROR_NOT_SUPPORTED Not supported
 ...
 * @see         dpm_create_client()
 * @see         dpm_destroy_client()
 * @see         dpm_is_mock_location_allowed()
 */
DPM_API int dpm_allow_mock_location(dpm_client_h handle, int allow);

/**
 * @brief       API to get the allow status of the mock location
 * @details     An administrator can use this API to get the allow status of
 *              the mock location
 * @since_tizen 3.0
 * @privlevel   public
 ...
 * @see         dpm_create_client()
 * @see         dpm_destroy_client()
 * @see         dpm_allow_mock_location()
 */
DPM_API int dpm_is_mock_location_allowed(dpm_client_h handle);
