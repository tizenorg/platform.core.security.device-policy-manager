 ...
 */
DPM_API int dpm_restriction_set_camera_state(device_policy_manager_h handle, int restrict);
 ...
 * @since_tizen 3.0
 * @param[in]   handle Device policy manager handle
 * @param[out]  is_restricted The camera allow status, true if the acess is restricted, false otherwise.
 * @return      #DPM_ERROR_NONE on success, otherwise a negative value
 * @retval      #DPM_ERROR_NONE Successful
 * @retval      #DPM_ERROR_INVALID_PARAMETER Invalid parameter
 * @retval      #DPM_ERROR_TIMED_OUT Time out
 ...
 */
DPM_API int dpm_restriction_get_camera_state(device_policy_manager_h handle, int *is_restricted);
 ...
 */
DPM_API int dpm_restriction_set_microphone_state(device_policy_manager_h handle, int restrict);
 ...
 * @since_tizen 3.0
 * @param[in]   handle Device policy manager handle
 * @param[out]  is_restricted The microphone allow status, true if the acess is restricted, false otherwise.
 * @return      #DPM_ERROR_NONE on success, otherwise a negative value
 * @retval      #DPM_ERROR_NONE Successful
 * @retval      #DPM_ERROR_INVALID_PARAMETER Invalid parameter
 * @retval      #DPM_ERROR_TIMED_OUT Time out
 ...
 */
DPM_API int dpm_restriction_get_microphone_state(device_policy_manager_h handle, int *is_restricted);
 ...
 */
DPM_API int dpm_restriction_set_location_state(device_policy_manager_h handle, int restrict);
 ...
 */
DPM_API int dpm_restriction_get_location_state(device_policy_manager_h handle, int *is_restricted);
 ...
 */
DPM_API int dpm_restriction_set_external_storage_state(device_policy_manager_h handle, int restrict);
 ...
 * @since_tizen 3.0
 * @param[in]   handle Device policy manager handle
 * @param[out]  is_restricted The external storage restriction status, true if the acess is restricted, false otherwise.
 * @return      #DPM_ERROR_NONE on success, otherwise a negative value
 * @retval      #DPM_ERROR_NONE Successful
 * @retval      #DPM_ERROR_TIMEOUT Time out
 * @retval      #DPM_ERROR_INVALID_PARAMETER Invalid parameter
 ...
 */
DPM_API int dpm_restriction_get_external_storage_state(device_policy_manager_h handle, int *is_restricted);
 ...
 */
DPM_API int dpm_restriction_set_clipboard_state(device_policy_manager_h handle, int restrict);
 ...
 * @since_tizen 3.0
 * @param[in]   handle Device policy manager handle
 * @param[out]  is_restricted The clipboard restriction status, true if the acess is restricted, false otherwise.
 * @return      #DPM_ERROR_NONE on success, otherwise a negative value
 * @retval      #DPM_ERROR_NONE Successful
 * @retval      #DPM_ERROR_TIMEOUT Time out
 * @retval      #DPM_ERROR_INVALID_PARAMETER Invalid parameter
 ...
 */
DPM_API int dpm_restriction_get_clipboard_state(device_policy_manager_h handle, int *is_restricted);
 ...
 */
DPM_API int dpm_restriction_set_usb_debugging_state(device_policy_manager_h handle, int restrict);
 ...
 */
DPM_API int dpm_restriction_get_usb_debugging_state(device_policy_manager_h handle, int *is_restricted);
 ...
 */
DPM_API int dpm_restriction_set_wifi_state(device_policy_manager_h handle, int restrict);
 ...
 */
DPM_API int dpm_restriction_get_wifi_state(device_policy_manager_h handle, int *is_restricted);
 ...
 */
DPM_API int dpm_restriction_set_wifi_hotspot_state(device_policy_manager_h handle, int restrict);
 ...
 */
DPM_API int dpm_restriction_get_wifi_hotspot_state(device_policy_manager_h handle, int *is_restricted);
 ...
 */
DPM_API int dpm_restriction_set_bluetooth_tethering_state(device_policy_manager_h handle, int restrict);
 ...
 */
DPM_API int dpm_restriction_get_bluetooth_tethering_state(device_policy_manager_h handle, int *is_restricted);
 ...
 */
DPM_API int dpm_restriction_set_usb_tethering_state(device_policy_manager_h handle, int restrict);
 ...
 */
DPM_API int dpm_restriction_get_usb_tethering_state(device_policy_manager_h handle, int *is_restricted);
 ...
 */
DPM_API int dpm_restriction_set_bluetooth_mode_change_state(device_policy_manager_h handle, int restrict);
 ...
 */
DPM_API int dpm_restriction_get_bluetooth_mode_change_state(device_policy_manager_h handle, int *is_restricted);
 ...
 */
DPM_API int dpm_restriction_set_bluetooth_desktop_connectivity_state(device_policy_manager_h handle, int restrict);
 ...
 */
DPM_API int dpm_restriction_get_bluetooth_desktop_connectivity_state(device_policy_manager_h handle, int *is_restricted);
 ...
 */
DPM_API int dpm_restriction_set_bluetooth_pairing_state(device_policy_manager_h handle, int restrict);
 ...
 */
DPM_API int dpm_restriction_get_bluetooth_pairing_state(device_policy_manager_h handle, int *is_restricted);
 ...
 */
DPM_API int dpm_restriction_set_messaging_state(device_policy_manager_h handle, int restrict);
...
*/
DPM_API int dpm_restriction_get_messaging_state(device_policy_manager_h handle, int *is_restricted);
...
*/
DPM_API int dpm_restriction_set_popimap_email_state(device_policy_manager_h handle, int restrict);
...
*/
DPM_API int dpm_restriction_get_popimap_email_state(device_policy_manager_h handle, int *is_restricted);
...
*/
DPM_API int dpm_restriction_set_browser_state(device_policy_manager_h handle, int restrict);
...
*/
DPM_API int dpm_restriction_get_browser_state(device_policy_manager_h handle, int *is_restricted);
