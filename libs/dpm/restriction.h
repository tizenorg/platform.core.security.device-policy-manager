...
/**
 * @brief       API to allow or disable the clipboard (required removing)
...
/**
 * @brief       API to get the allow status of the clipboard (required removing)
...
/**
 * @brief       API to enable or disable access to the clipboard.
 * @details     An administrator can use this API to set whether the clipboard
 *              is accessed or not
 * @since_tizen 3.0
 * @privlevel   public
 ...
 * @see         dpm_create_client()
 * @see         dpm_destroy_client()
 * @see         dpm_is_clipboard_enable_restricted()
 */
DPM_API int dpm_set_clipboard_enable(dpm_client_h handle, int enable);
 ...
 * @see         dpm_create_client()
 * @see         dpm_destroy_client()
 * @see         dpm_set_clipboard_enable()
 */
DPM_API int dpm_is_clipboard_enable_restricted(dpm_client_h handle);

/**
 * @brief       API to allow or disallow sharing the clipboard between applications.
 * @details     An administrator can use this API to set whether the clipboard
 ...
 * @privilege   %http://tizen.org/privilege/dpm.restriction
 * @param[in]   handle Device Policy Client handle
 * @param[in]   enable If true, allow to share the clipboard, if false, disable to share the clipboard
 * @return      #DPM_ERROR_NONE on success, otherwise a negative value
 * @retval      #DPM_ERROR_NONE Successful
 * @retval      #DPM_ERROR_NOT_SUPPORTED Not supported
 * @retval      #DPM_ERROR_ACCESS_DENIED The application does not have
 ...
 * @see         dpm_create_client()
 * @see         dpm_destroy_client()
 * @see         dpm_is_clipboard_share_restricted()
 */
DPM_API int dpm_allow_clipboard_share(dpm_client_h handle, int enable);

/**
 * @brief       API to get the allow status of sharing the clipboard between applications.
 * @details     An administrator can use this API to get the allow status of
 *              sharing clipboard between applications.
 * @since_tizen 3.0
 * @privlevel   public
 * @param[in]   handle Device Policy Client handle
 * @return      true if the clipboard can shared data, else false
 * @pre         handle must be created by dpm_create_client()
 * @post
 * @see         dpm_create_client()
 * @see         dpm_destroy_client()
 * @see         dpm_allow_clipboard_share()
 */
