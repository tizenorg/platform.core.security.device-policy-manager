 ...
 */
DPM_API int dpm_clipboard_set_state(dpm_context_h handle, int enable);
 ...
 */
DPM_API int dpm_clipboard_get_state(dpm_context_h handle);
 ...
 */
DPM_API int dpm_settings_set_restriction(dpm_context_h handle, int enable);
 ...
 */
DPM_API int dpm_settings_is_restricted(dpm_context_h handle);
 ...
 */
DPM_API int dpm_developer_set_usb_debugging_state(dpm_context_h handle, int enable);
 ...
 */
DPM_API int dpm_developer_get_usb_debugging_state(dpm_context_h handle);
 ...
 */
DPM_API int dpm_storage_set_usb_mass_storage_state(dpm_context_h handle, int enable);
 ...
 */
DPM_API int dpm_storage_get_usb_mass_storage_state(dpm_context_h handle);
 ...
 * @see         dpm_destroy_context()
 */
DPM_API int dpm_device_wipe_data(dpm_context_h handle);
