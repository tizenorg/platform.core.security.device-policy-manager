 ...
 * @since_tizen 3.0
 * @param[in]   handle The restriction policy handle
 * @param[out]  state The state of microphone
 ...
 */
DPM_API int dpm_restriction_get_microphone_state(dpm_restriction_policy_h handle, int *state);
 ...
 * @privlevel   public
 * @param[in]   handle The restriction policy handle
 * @param[out]  state The state of location
 * @return      status Allow status of localtion state change
 * @pre         handle must be created by dpm_context_acquire_restriction_policy()
 * @see         dpm_context_acquire_restriction_policy()
 * @see         dpm_context_release_restriction_policy()
 */
DPM_API int dpm_restriction_get_location_state(dpm_restriction_policy_h handle, int *state);
 ...
 */
DPM_API int dpm_restriction_get_settings_changes_state(dpm_restriction_policy_h handle, int *state);
