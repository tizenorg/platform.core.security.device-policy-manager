...
/**
 * @file developer.h
 * @brief This file provides APIs to control developer support functionlity
 */
...
/**
 * @brief       Acquires the developer policy handle.
 * @details     This API acquires developer handle required to enforce
 *              the development support features.
 * @since_tizen 3.0
 * @param[in]   handle Device policy context handle
 * @return      Developer policy handle on success, otherwise NULL
...
/**
 * @brief       Releases the DeveloperPolicy Context Handle.
