...
/**
  * @brief       The DeveloperPolicy Context Handle
  * @since_tizen 3.0
...
/**
  * @brief       Acquires the DeveloperPolicy Context Handle.
  * @details     This API acquires device developer policy handle required to call
  *              the developer policy APIs.
  * @since_tizen 3.0
  * @param[in]   handle DeveloperPolicy Context Handle
  * @param[in]   zone Target container name.
  * @return      DeveloperPolicy handle on success, otherwise NULL
