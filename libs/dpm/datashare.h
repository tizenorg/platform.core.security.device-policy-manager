 ...
 */
 ...
 /**
  * @brief       The DatasharePolicy Context Handle
  * @since_tizen 3.0
...
/**
  * @brief       Acquires the DatasharePolicy Context Handle.
  * @details     This API acquires device datashare policy handle required to call
  *              the datashare policy APIs.
  * @since_tizen 3.0
  * @param[in]   handle DatasharePolicy Context Handle
  * @param[in]   zone Target container name.
  * @return      DatasharePolicy handle on success, otherwise NULL
 ...
 /**
  * @brief       Releases the DatasharePolicy Context Handle.
