 ...
 * @since_tizen 3.0
 * @param[in]   handle Device Policy Client handle
 * @param[out]  status The restriction status of the camera
 * @return      #DPM_ERROR_NONE on success, otherwise a negative value
 * @retval      #DPM_ERROR_NONE Successful
 * @retval      #DPM_ERROR_TIMED_OUT Time out
 * @retval      #DPM_ERROR_INVALID_PARAMETER Invalid parameter
 ...
 * @privlevel   public
 * @param[in]   handle Device Policy Client handle
 * @param[out]  status Restriction status of localtion
 * @return      #DPM_ERROR_NONE on success, otherwise a negative value
 * @retval      #DPM_ERROR_NONE Successful
 * @retval      #DPM_ERROR_TIMEOUT Timeout
 * @retval      #DPM_ERROR_ACCESS_DENIED The application does not have
 ...
 * @see         dpm_destroy_client()
 */
DPM_API int dpm_is_location_restricted(dpm_client_h handle, int *status);
 ...
 * @privlevel   public
 * @param[in]   handle Device Policy Client handle
 * @param[out   status Restriction status of the SD Card
 * @return      #DPM_ERROR_NONE on success, otherwise a negative value
 * @retval      #DPM_ERROR_NONE Successful
 * @retval      #DPM_ERROR_TIMEOUT Timeout
 * @retval      #DPM_ERROR_ACCESS_DENIED The application does not have
 ...
 * @see         dpm_destroy_client()
 */
DPM_API int dpm_is_sd_card_restricted(dpm_client_h handle, int *status);
