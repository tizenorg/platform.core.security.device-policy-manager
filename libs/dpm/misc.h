...
/**
 * @brief       API to enable or disable the camera.
 ...
 */
DPM_API int dpm_set_allow_camera(dpm_client_h handle, const bool enable);
 ...
 * @see         dpm_destroy_client()
 */
DPM_API bool dpm_get_allow_camera(dpm_client_h handle);

/**
 * @brief       API to enable or disable the microphone.
 ...
 * @see         dpm_destroy_client()
 */
DPM_API int dpm_set_allow_microphone(dpm_client_h handle, const bool enable);
 ...
 * @see         dpm_destroy_client()
 */
DPM_API bool dpm_get_allow_microphone(dpm_client_h handle);

/**
 * @brief       API to enable or disable the location.
 ...
 * @privilege   %http://tizen.org/privilege/dpm.misc
 * @param[in]   handle Device Policy Client handle
 * @param[in]   enable If true, enable the location, if false, disable the location
 * @return      #DPM_ERROR_NONE on success, otherwise a negative value
 * @retval      #DPM_ERROR_NONE Successful
 * @retval      #DPM_ERROR_NOT_SUPPORTED Not supported
 * @retval      #DPM_ERROR_ACCESS_DENIED The application does not have
 ...
 * @see         dpm_destroy_client()
 */
DPM_API int dpm_set_allow_location(dpm_client_h handle, const bool enable);
 ...
 * @see         dpm_destroy_client()
 */
DPM_API bool dpm_get_allow_location(dpm_client_h handle);

/**
 * @brief       API to enable or disable the sd card.
 ...
 * @privilege   %http://tizen.org/privilege/dpm.misc
 * @param[in]   handle Device Policy Client handle
 * @param[in]   enable If true, enable the sd card, if false, disable the sd card
 * @return      #DPM_ERROR_NONE on success, otherwise a negative value
 * @retval      #DPM_ERROR_NONE Successful
 * @retval      #DPM_ERROR_NOT_SUPPORTED Not supported
 * @retval      #DPM_ERROR_ACCESS_DENIED The application does not have
 ...
 * @see         dpm_destroy_client()
 */
DPM_API int dpm_set_allow_sd_card(dpm_client_h handle, const bool enable);
 ...
 * @see         dpm_destroy_client()
 */
DPM_API bool dpm_get_allow_sd_card(dpm_client_h handle);
