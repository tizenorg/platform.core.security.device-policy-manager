 ...
 */
DPM_API int dpm_security_is_internal_storage_encrypted(device_policy_manager_h handle, int *state);
...
typedef enum {
	...
	DPM_SECURITY_WIPE_INTERNAL_AND_EXTERNAL_STORAGE = (1 << 1)  /**< Wipe both memory */
