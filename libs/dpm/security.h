 ...
 */
DPM_API int dpm_security_set_internal_storage_encryption(device_policy_manager_h handle, bool encrypt);
 ...
 */
DPM_API int dpm_security_is_internal_storage_encrypted(device_policy_manager_h handle, bool *is_encrypted);
 ...
 */
DPM_API int dpm_security_set_external_storage_encryption(device_policy_manager_h handle, bool encrypt);
 ...
 */
DPM_API int dpm_security_is_external_storage_encrypted(device_policy_manager_h handle, int *is_encrypted);
 ...
 * @see         dpm_manager_create()
 */
DPM_API int dpm_security_wipe_data(device_policy_manager_h handle, dpm_security_wipe_type_e type);
