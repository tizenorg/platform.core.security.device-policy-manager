 ...
 */
DPM_API int dpm_admin_register_client(device_policy_manager_h handle, const char* name);
 ...
 */
DPM_API int dpm_admin_deregister_client(device_policy_manager_h handle, const char* name);
