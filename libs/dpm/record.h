...
/**
 * @brief       The Record Policy handle
 * @since_tizen 3.0
 ...
 * @details     This API acquires record policy handle required to call
 *              the device policy record APIs.
 * @since_tizen 3.0
 ...
 * @see         get_last_result()
 */
DPM_API dpm_record_policy_h dpm_context_acquire_record_policy(dpm_context_h handle, const char* zone);
 ...
 * @since_tizen 3.0
 * @param[in]   handle Record Policy Handle
 ...
 * @param[in]   handle Record Policy Handle handle
 ...
 */
DPM_API int dpm_record_set_mic_state(dpm_record_policy_h handle, int enable);
 ...
 * @see         dpm_context_destroy()
 */
DPM_API int dpm_record_get_mic_state(dpm_record_policy_h handle);
