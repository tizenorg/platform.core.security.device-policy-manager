...
/**
 * @brief       Fetches a package handle and forwards the iterator.
 * @details     This API returns package handle indicated by the iterator, and then
 *              the iterator is moved to the next position. If the iterator reaches
 *              the end of the list, null value will be returned.
 * @since_tizen 3.0
 * @param[in]   iter The iterator to be controlled
 * @param[out]  pkg The package handle got from the iterator
 * @return      #DPM_ERROR_NONE on success, otherwise a negative value
 * @retval      #DPM_ERROR_NONE Successful
 * @retval      #DPM_ERROR_INVALID_PARAMETER Invalid parameter
 * @retval      #DPM_ERROR_TIMED_OUT Time out
 ...
 * @see         dpm_zone_pkg_destroy_iterator()
 */
DPM_API int dpm_zone_pkg_iterator_next(dpm_zone_iterator_h iter, dpm_zone_pkg_h *pkg);
 ...
 * @see         get_last_result()
 */
DPM_API dpm_zone_pkg_h dpm_zone_pkg_acquire(dpm_zone_policy_h handle, const char* name, const char* pkgid);
 ...
 */
DPM_API int dpm_zone_get_pkg_label(dpm_zone_pkg_h pkg, const char** label);
 ...
 */
DPM_API int dpm_zone_get_pkg_version(dpm_zone_pkg_h pkg, const char** version);
 ...
 */
DPM_API int dpm_zone_pkg_install(dpm_zone_policy_h handle, const char* name, const char* pkgpath);
 ...
 */
DPM_API int dpm_zone_pkg_uninstall(dpm_zone_pkg_h pkg);
 ...
 *              application handles in the zone.
 * @since_tizen 3.0
 * @param[in]   pkg The package handle
 ...
 * @see         get_last_result()
 */
DPM_API dpm_zone_uiapp_iterator_h dpm_zone_uiapp_create_iterator(dpm_zone_pkg_h pkg);

/**
 * @brief       Fetches an application handle and forwards the iterator.
 * @details     This API returns application handle indicated by the iterator, and then
 *              the iterator is moved to the next position. If the iterator reaches
 *              the end of the list, null value will be returned.
 * @since_tizen 3.0
 * @param[in]   iter The iterator to be controlled
 ...
 * @see         dpm_zone_uiapp_destroy_iterator()
 */
DPM_API int dpm_zone_uiapp_iterator_next(dpm_zone_uiapp_iterator_h iter, dpm_zone_app_h app);
 ...
 */
typedef void(*dpm_zone_uiapp_foreach_cb)(dpm_zone_app_h app, void *user_data);
...
*/
DPM_API int dpm_zone_foreach_uiapp(dpm_zone_pkg_h handle,
                                   dpm_zone_uiapp_foreach_cb callback,
                                   void* user_data);
 ...
 * @see         get_last_result()
 */
DPM_API dpm_zone_pkg_h dpm_zone_app_acquire(dpm_zone_pkg_h pkg, const char* appid);
 ...
 */
DPM_API int dpm_zone_app_release(dpm_zone_pkg_h pkg);
 ...
 * @see         dpm_zone_app_is_running_app()
 */
 ...
 * @see         dpm_context_acquire_zone_policy()
 * @see         dpm_context_release_zone_policy()
 * @see         dpm_zone_app_resume()
 * @see         dpm_zone_app_terminate()
 * @see         app_control_send_launch_request()
 */
DPM_API int dpm_zone_app_launch(dpm_zone_app_h app);
 ...
 * @see         dpm_context_acquire_zone_policy()
 * @see         dpm_context_release_zone_policy()
 * @see         dpm_zone_app_launch()
 * @see         dpm_zone_app_terminate()
 */
DPM_API int dpm_zone_app_resume(dpm_zone_app_h app);
 ...
 */
DPM_API int dpm_zone_app_terminate(dpm_zone_app_h app);
 ...
 * @see         dpm_zone_app_is_taskmanaged()
 */
DPM_API int dpm_zone_app_is_running(dpm_zone_app_h app, int* result);
