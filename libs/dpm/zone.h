 ...
 * @see         dpm_context_create_zone_policy()
 */
DPM_API void dpm_context_destroy_zone_policy(dpm_zone_policy_h handle);
 ...
 * @see         dpm_zone_remove_signal_cb()
 */
DPM_API int dpm_zone_add_signal_cb(dpm_zone_policy_h handle, dpm_zone_signal_e signals, dpm_zone_signal_cb handler, void* user_data);
