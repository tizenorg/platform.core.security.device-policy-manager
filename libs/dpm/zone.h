 ...
 *              zone can be created. the package in charge of UI flow should
 *              be chosen by pkgid. Containers can be created as many as
 *              the device can do.
 * @since_tizen 3.0
 * @privlevel   public
 ...
 * @see         dpm_zone_add_signal_cb()
 */
DPM_API int dpm_zone_remove_signal_cb(dpm_zone_policy_h handle, dpm_zone_signal_cb_h id);
