 ...
 */
typedef enum {
    DPM_ZONE_SIGNAL_SETUP_SUCCEEDED         = 0x001, /**< Zone setup process has been succeeded. */
    DPM_ZONE_SIGNAL_SETUP_FAILED            = 0x002, /**< Zone setup process has been failed. */
    DPM_ZONE_SIGNAL_REMOVE_SUCCEEDED        = 0x004, /**< Zone has been removed. */
 ...
 * @see         dpm_zone_remove_signal_cb()
 */
DPM_API int dpm_zone_add_signal_cb(dpm_zone_policy_h handle, dpm_zone_signal_e signals, dpm_zone_signal_cb callback, void* user_data);
