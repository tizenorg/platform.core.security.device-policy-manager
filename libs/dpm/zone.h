 ...
 * @since_tizen 3.0
 * @param[in]   handle The zone policy handle
 * @param[in]   signal The signal of the container not to be monitored
 ...
 * @see         dpm_zone_add_signal_cb()
 */
DPM_API int dpm_zone_remove_signal_cb(dpm_zone_policy_h handle, dpm_zone_signal_e signal, int id);
