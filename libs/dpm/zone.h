...
/**
 * @addtogroup  CAPI_SECURITY_DPM_ZONE_POLICY_MODULE
 * @{
 */

/**
 * @brief       The Device Policy Zone handle
 * @details     The Device Policy Zone Handle is an abstraction of the
 *              logical connection between the device policy manager and
 *              it's client. The Device Policy Zone handle must be
 ...
 * @param[in]   handle The device policy zone handle
 ...
 * @pre         handle must be created by dpm_context_create_zone_policy()
 * @see         dpm_context_create_zone_policy()
 * @see         dpm_context_destroy_zone_policy()
 * @see         dpm_zone_destroy()
 * @see         dpm_zone_create_iterator()
 */
DPM_API int dpm_zone_create(dpm_zone_h handle, const char* name, const char* pkgid);
 ...
 * @see         dpm_zone_create_iterator()
 */
DPM_API int dpm_zone_destroy(dpm_zone_h handle, const char* name);
 ...
 */
DPM_API dpm_zone_iterator_h dpm_zone_create_iterator(dpm_zone_h handle);
 ...
 * @pre         iter must be created by dpm_zone_create_iterator()
 * @see         dpm_zone_create_iterator()
 * @see         dpm_zone_destroy_iterator()
 */
 ...
 * @see         dpm_zone_iterator_next()
 */
DPM_API void dpm_zone_destroy_iterator(dpm_zone_iterator_h iter);
 ...
 */
DPM_API int dpm_zone_get_state(dpm_zone_h handle, const char *name, dpm_zone_state_e *state);
 ...
 * @param[in]   handler The zone signal callback
 ...
 * @see         dpm_zone_remove_signal_cb()
 */
DPM_API int dpm_zone_add_signal_cb(dpm_zone_h handle, dpm_zone_signal_e signals, dpm_zone_signal_cb handler, void* user_data);
 ...
 * @see         dpm_zone_add_signal_cb()
 */
DPM_API int dpm_zone_remove_signal_cb(dpm_zone_h handle, int id);
