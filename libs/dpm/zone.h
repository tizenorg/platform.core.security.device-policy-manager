 ...
 */
typedef enum {
    DPM_SIGNAL_ZONE_SETUP_SUCCESS           = 0x001, /**< Zone setup process has been succeed. */
    DPM_SIGNAL_ZONE_SETUP_FAILURE           = 0x002, /**< Zone setup process has been failed. */
    DPM_SIGNAL_ZONE_REMOVED                 = 0x008, /**< Zone has been removed. */
} dpm_zone_signal_e;
