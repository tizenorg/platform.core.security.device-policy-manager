...
/**
 * @brief       The ZonePolicy Policy handle
 * @since_tizen 3.0
...
/**
 * @brief       Acquires the ZonePolicy Policy handle
 ...
 * @return      ZonePolicy Policy handle on success, otherwise NULL
...
/**
 * @brief       ZonePolicy list iterator handle
 * @since_tizen 3.0
 * @see         dpm_zone_create_iterator()
 ...
 * @param[in]   user_data The user data passed to the callback function
 * @param[out]  id ZonePolicy signal identifier
 * @return      #DPM_ERROR_NONE on success, otherwise a negative value
 * @retval      #DPM_ERROR_NONE Successful
 * @retval      #DPM_ERROR_INVALID_PARAMETER Invalid parameter
 * @retval      #DPM_ERROR_TIMED_OUT Time out
 ...
 * @since_tizen 3.0
 * @param[in]   handle The zone policy handle
 * @param[in]   id ZonePolicy signal identifier
 * @return      #DPM_ERROR_NONE on success, otherwise a negative value
 * @retval      #DPM_ERROR_NONE Successful
 * @retval      #DPM_ERROR_INVALID_PARAMETER Invalid parameter
 * @retval      #DPM_ERROR_TIMED_OUT Time out
