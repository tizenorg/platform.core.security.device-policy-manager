...
{
	try {
		return context->methodCall<int>("SettingsPolicy::setSettingsChangesRestriction", enable);
...
{
	try {
		return context->methodCall<bool>("SettingsPolicy::isSettingsChangesRestricted");
	} catch (runtime::Exception& e) {
		return -1;
	}
}
