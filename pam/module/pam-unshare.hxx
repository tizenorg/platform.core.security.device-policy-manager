...
#ifndef __PAM_UNSHARE__
#define __PAM_UNSHARE__
...
class PAMUnshare : public PAM<PAMUnshare> {
public:
    PAMUnshare(pam_handle_t* pamh);
    ~PAMUnshare();

    friend class PAM;

protected:
    void attachNamespace(pid_t pid, int flags);
...
private:
    void translatePathParameter(std::string& path);
};

} // namespace Runtime
#endif // __PAM_UNSHARE__
