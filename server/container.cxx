    ...
    : context(ctx)
{
    ...
    manager.registerNonparametricMethod(this, (std::vector<std::string>)(Container::getList)());

    manager.registerParametricMethod(this, (int)(Container::getState)(std::string));
}
...
int Container::create(const std::string& name, const std::string& setupWizAppid)
{
    ...
    try {
        ...
        // Create container home's directories
        const struct {
