    ...
    context(ctxt)
{
	...
	manager.registerParametricMethod(this, (int)(Misc::allowCamera)(bool));
	manager.registerNonparametricMethod(this, (bool)(Misc::isCameraAllowed));
	manager.registerParametricMethod(this, (int)(Misc::allowMicrophone)(bool));
	manager.registerNonparametricMethod(this, (bool)(Misc::isMicrophoneAllowed));
	manager.registerParametricMethod(this, (int)(Misc::allowLocation)(bool));
	manager.registerNonparametricMethod(this, (bool)(Misc::isLocationAllowed));
	manager.registerParametricMethod(this, (int)(Misc::allowSdCard)(bool));
	manager.registerNonparametricMethod(this, (bool)(Misc::isSdCardAllowed));
}
