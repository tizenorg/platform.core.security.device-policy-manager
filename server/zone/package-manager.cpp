    ...
    : context(ctx)
{
    ...
    context.registerParametricMethod(this, (std::vector<std::string>)(ZonePackageManager::getIdList)(std::string));
...
std::vector<std::string> ZonePackageManager::getIdList(const std::string& name)
{
    try {
        runtime::User user(name);
