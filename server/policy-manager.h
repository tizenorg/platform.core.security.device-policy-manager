...
//typedef bool (*PolicyStateComparator)(const std::string& new_val, const std::string& old_val);
...
private:
	...
	void initialize();
	void setEffectivePolicy(const std::string& policy, const std::string& state);
};
