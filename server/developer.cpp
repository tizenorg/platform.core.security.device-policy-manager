...
DeveloperPolicy::DeveloperPolicy(PolicyControlContext& ctx) :
    context(ctx)
{
	context.registerParametricMethod(this, (int)(DeveloperPolicy::setUsbDebuggingState)(bool));
	context.registerNonparametricMethod(this, (bool)(DeveloperPolicy::getUsbDebuggingState));
}
...
{
    INFO("Start DeveloperPolicy::setUsbDebuggingState");
...
{
	int status;
	INFO("Start DeveloperPolicy::getUsbDebuggingState");
