...
int AdministrationPolicy::registerPolicyClient(const std::string& name, int uid)
{
...
int AdministrationPolicy::deregisterPolicyClient(const std::string& name, int uid)
{
	ClientManager& manager = ClientManager::instance();
