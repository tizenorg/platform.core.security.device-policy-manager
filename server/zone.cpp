...
std::vector<std::string> defaultAppDirs = {
    "cache",
    "data",
    "shared"
};

std::vector<std::string> unitsToMask = {
    "starter.service",
    "scim.service"
};
...
const char *HOME_SMACKLABEL = "User::Home";
const char *SHARED_SMACKLABEL = "User::App::Shared";
const char *APP_SMACKLABEL = "User::Pkg::";
