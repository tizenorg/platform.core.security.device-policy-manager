...
popup_info_s popup_list[DPM_SYSPOPUP_MAX] = {
	/* Application Policy */
	{"install_mode",   "IDS_DPM_HEADER_APPLICATION_POLICY", "IDS_DPM_BODY_PREVENT_INSTALL_MODE"},
	{"uninstall_mode", "IDS_DPM_HEADER_APPLICATION_POLICY", "IDS_DPM_BODY_PREVENT_UNINSTALL_MODE"},

	/* Password Policy */
	{"password_expires",        "IDS_DPM_HEADER_PASSWORD_POLICY", "IDS_DPM_BODY_PASSWORD_EXPIRES"},
	...
	{"password_delete_pattern", "IDS_DPM_HEADER_PASSWORD_POLICY", "IDS_DPM_BODY_PASSWORD_DELETE_PATTERN"},
	{"password_set_pattern",    "IDS_DPM_HEADER_PASSWORD_POLICY", "IDS_DPM_BODY_PASSWORD_SET_PATTERN"},

	/* Wi-Fi Policy */
	{"wifi",    "IDS_DPM_HEADER_WIFI_POLICY", "IDS_DPM_BODY_PREVENT_WIFI"},
	{"hotspot", "IDS_DPM_HEADER_WIFI_POLICY", "IDS_DPM_BODY_PREVENT_HOTSPOT"},
	...
	{"settings_changes", "IDS_DPM_HEADER_SETTING_POLICY",  "IDS_DPM_BODY_PREVENT_SETTINGS_CHANGES"},

	/* Storage Policy */
	{"external_storage",   "IDS_DPM_HEADER_STORAGE_POLICY", "IDS_DPM_BODY_PREVENT_EXTERNAL_STORAGE"},
	{"storage_encryption", "IDS_DPM_HEADER_STORAGE_POLICY", "IDS_DPM_BODY_PREVENT_STORAGE_ENCRYPTION"},
	{"storage_decryption", "IDS_DPM_HEADER_STORAGE_POLICY", "IDS_DPM_BODY_PREVENT_STORAGE_DECRYPTION"},
