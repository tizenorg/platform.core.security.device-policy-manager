...
static void printUsage()
{
	...
	printf("Options:\n");
	printf("  -r --register   : *Mandatory* registration admin client with package name and uid\n");
	printf("  -d --deregister : *Mandatory* deregistration admin client with package name and uid\n");
	printf("  -u --user       : *Mandatory* user name of admin client\n");
