...
%cmake . -DVERSION=%{version} \
         ...
         -DAPP_DESKTOP_ICON_DIR="%{TZ_SYS_RO_ICONS}/default/small" \
...
%{setup_home}/shared/res/*.png
%{TZ_SYS_RO_PACKAGES}/org.tizen.zone-setup-wizard.xml
%{TZ_SYS_RO_ICONS}/default/small/org.tizen.zone-setup-wizard/org.tizen.zone-setup-wizard.png
