...
public:
    ...
    int setMinimumComplexCharacters(int value);
    int getMinimumComplexCharacters();
    int setMaximumFailureCount(int value);
    int getMaximumFailureCount();
    int setExpires(int value);
    int getExpires();
    int setHistorySize(int value);
    int getHistorySize();
    int setPattern(const std::string &pattern);
    int reset(const std::string &passwd);
    int enforceChange();
    int setMaximumInactivityTimeDeviceLock(int value);
    int getMaximumInactivityTimeDeviceLock();
