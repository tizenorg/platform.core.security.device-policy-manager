...
private:
    ...
    PasswordQuality __qualityType;
    unsigned int __minLength;
    unsigned int __minComplexCharNumber;
    unsigned int __maxAttempts;
    unsigned int __validPeriod;
    unsigned int __historySize;
    std::string __pattern;
    std::string __password;
    unsigned int __maxInactivityTime;
    unsigned int __passwdStatus;
    unsigned int __maxCharOccurrences;
    unsigned int __maxNumSeqLength;
    std::vector<std::string> __forbiddenPasswds;
};
