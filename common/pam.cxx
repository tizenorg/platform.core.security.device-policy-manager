...
void PAM::setData(std::string name, void* data, void (*cleanup)(pam_handle_t* pamh, void* data, int error))
{
...
const void* PAM::getData(std::string name) const
{
    const void* ret;
...
const std::string PAM::getUser(std::string prompt) const
{
    const char* user;
...
void PAM::putEnv(std::string name_value)
{
...
const std::string PAM::getEnv(std::string name) const
{
