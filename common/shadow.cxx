...
void Shadow::put(std::string& filename, const pwdStruct& pwd,
...
void Shadow::remove(std::string& filename, const element& value,
                    std::function<int(const pwdStruct*, FILE*)> put,
...
void Shadow::putShadow(std::string filename, const struct spwd& ent)
{
    put<struct spwd>(filename, ent, putspent);
}

void Shadow::putGroup(std::string filename, const struct group& ent)
{
    put<struct group>(filename, ent, putgrent);
}

void Shadow::putGshadow(std::string filename, const struct sgrp& ent)
{
    put<struct sgrp>(filename, ent, putsgent);
}


void Shadow::removePasswd(std::string filename, uid_t uid)
{
...
void Shadow::removeShadow(std::string filename, std::string user)
{
...
void Shadow::removeGroup(std::string filename, gid_t gid)
{
...
void Shadow::removeGshadow(std::string filename, std::string group)
{
