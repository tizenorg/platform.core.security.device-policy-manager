#ifndef __RUNTIME_ECRYPTFS_COMMON_H__
#define __RUNTIME_ECRYPTFS_COMMON_H__
...
typedef enum {
        ECRYPTFS_ERROR_NONE = 0,
        ECRYPTFS_ERROR_BUSY = EBUSY,
        ECRYPTFS_ERROR_INVALID = EINVAL,
        ECRYPTFS_ERROR_EXIST = EEXIST,
        ECRYPTFS_ERROR_OUT_OF_MEMORY = ENOMEM,
        ECRYPTFS_ERROR_ACCESS_DENIED = EACCES,
        ECRYPTFS_ERROR_NO_OBJECT = ENOENT,
        ECRYPTFS_ERROR_FAIL,
} ecryptfs_error_e;

typedef enum {
	ECRYPTFS_UNMOUNTED = 1,
	ECRYPTFS_MOUNTED = 2,
} ecryptfs_state_e;
