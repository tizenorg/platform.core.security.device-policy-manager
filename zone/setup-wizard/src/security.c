...
static void __create_password_set_view(appdata_s *ad)
{
	...
	left_button = _create_button(layout, "Previous", __security_prev_cb, NULL);
	right_button = _create_button(layout, "Set up", __security_setup_cb, ad);
...
void _create_security_view(appdata_s *ad)
{
	...
	left_button = _create_button(layout, "Previous", __security_prev_cb, NULL);
	right_button = _create_button(layout, "Next", __security_next_cb, ad);
