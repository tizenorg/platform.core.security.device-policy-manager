 ...
 * @since_tizen 3.0
 * @see         zone_app_manager_create()
 * @see         zone_app_manager_destroy()
 */
 ...
 * @see         get_last_result()
 */
ZONE_API int zone_app_manager_create(zone_app_manager_h* handle);
 ...
 * @pre         The handle must be created by zone_app_manager_create()
 * @see         zone_app_manager_create()
 */
ZONE_API int zone_app_manager_destroy(zone_app_manager_h handle);
 ...
 * @see         get_last_result()
 */
ZONE_API int zone_app_manager_get_app_info(zone_app_manager_h handle, const char* name, const char* appid, app_info_h* app_info);
 ...
 */
ZONE_API int zone_app_manager_foreach_app_info(zone_app_manager_h handle, const char* name, app_manager_app_info_cb callback, void *user_data);
 ...
 */
ZONE_API int zone_app_manager_launch(zone_app_manager_h handle, const char* name, const char* appid);
 ...
 * @see         zone_is_running_app()
 */
ZONE_API int zone_app_manager_resume(zone_app_manager_h handle, const char* name, const char* appid);
 ...
 */
ZONE_API int zone_app_manager_terminate(zone_app_manager_h handle, const char* name, const char* appid);
 ...
 * @see         zone_terminate_app()
 */
ZONE_API int zone_app_manager_is_running(zone_app_manager_h handle, const char* name, const char* appid, int* result);
