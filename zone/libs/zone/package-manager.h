 ...
 * @see         get_last_result()
 */
ZONE_API int zone_package_manager_get_package_info(zone_package_manager_h handle, const char* name, const char* pakcage_id, package_info_h* package_info);
 ...
 */
ZONE_API int zone_package_manager_install(zone_package_manager_h handle, const char* name, const char* package_path);
 ...
 */
ZONE_API int zone_package_manager_uninstall(zone_package_manager_h handle, const char* name, const char* pakcage_id);
