...
std::vector<ZoneAppManager::AppInfo> ZoneAppManager::getList(const std::string& zone)
{
    try {
        return context->methodCall<std::vector<ZoneAppManager::AppInfo>>("ZoneAppManager::getList", zone);
    } catch (runtime::Exception& e) {}
