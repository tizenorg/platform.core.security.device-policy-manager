...
std::vector<ZonePackageManager::PkgInfo> ZonePackageManager::getList(const std::string& zone)
{
    try {
        return context->methodCall<std::vector<ZonePackageManager::PkgInfo>>("ZonePackageManager::getList", zone);
    } catch (runtime::Exception& e) {}
    return std::vector<ZonePackageManager::PkgInfo>();;
}
